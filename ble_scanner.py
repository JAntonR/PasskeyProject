...
# Your target iBeacon UUID (set in BeaconSimulator app)
TARGET_UUID = "b9407f30-f5f8-466e-aff9-25556b57fe6d".lower()

# File used to communicate with Flask backend
    ...
    while True:
        ...
        for d in devices:
            for data in d.metadata.get("manufacturer_data", {}).values():
                if len(data) >= 23 and data[0:2] == b'\x02\x15':  # iBeacon prefix
